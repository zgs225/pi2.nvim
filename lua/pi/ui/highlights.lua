...
local function set_defaults()
    ...
    local diag_hint = vim.api.nvim_get_hl(0, { name = "DiagnosticHint", link = false })
    ...
    vim.api.nvim_set_hl(0, "PiThinkingOff", { default = true, fg = comment.fg })
    vim.api.nvim_set_hl(0, "PiThinkingMinimal", { default = true, fg = comment.fg })
    vim.api.nvim_set_hl(0, "PiThinkingLow", { default = true, fg = diag_info.fg or func.fg })
    vim.api.nvim_set_hl(0, "PiThinkingMedium", { default = true, fg = diag_hint.fg or special.fg })
    vim.api.nvim_set_hl(0, "PiThinkingHigh", { default = true, fg = special.fg, bold = true })
    vim.api.nvim_set_hl(0, "PiThinkingXhigh", { default = true, fg = title.fg, bold = true })
    vim.api.nvim_set_hl(0, "PiThinkingMax", { default = true, fg = diag_warn.fg or warning.fg, bold = true })
